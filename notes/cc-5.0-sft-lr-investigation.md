...
snorkel_finance_split/thoughts_policy_adamw30_lr1e_3_nb200_flat32sgd hide   54     2.5260 ->   2.4707   2.19%  0.8349        2.7776  <running>

10/30 arms complete   (Δ% = held-out action-subspan PPL improvement, higher is better)
```
_last refreshed: 2026-09-02 10:20_
<!--/RESULTS-->
