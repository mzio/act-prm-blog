...
snorkel_finance_split/thoughts_policy_adamw30_lr1e_3_nb200_flat32sgd hide   21     2.5260 ->   2.5144   0.46%  0.8350        4.9426  <running>

10/30 arms complete   (Δ% = held-out action-subspan PPL improvement, higher is better)
```
_last refreshed: 2026-09-02 10:00_
<!--/RESULTS-->
