...
airline/actions_only_lr1e_3_adamw_nb100              hide   32     2.1901 ->   2.3495  -7.27%  0.7902        1.2734  <running>

2/7 arms complete   (Δ% = held-out action-subspan PPL improvement, higher is better)
```
_last refreshed: 2026-08-30 05:20_
<!--/RESULTS-->
